...
class EmailAddress extends AbstractValidator
{
    ...
    protected $messageTemplates = array(
        self::INVALID            => "Пошли нахуй",//"Invalid type given. String expected",
        self::INVALID_FORMAT     => "Вы ввели некорректный адрес E-mail.",//"The input is not a valid email address. Use the basic format local-part@hostname",
        self::INVALID_HOSTNAME   => "'%hostname%'неверно указан :local-part@hostname", //is not a valid hostname for the email address ",
        self::INVALID_MX_RECORD  => "'%hostname%'неверно указан домен: local-part@hostname(.ru-это домен)",// does not appear to have any valid MX or A records for the email address",
