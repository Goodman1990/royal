...
class Regex extends AbstractValidator
{
    ...
    protected $messageTemplates = array(
        self::INVALID   => "Неверный тип введеных данных",//"Invalid type given. String, integer or float expected",
        self::NOT_MATCH => "разрешенные символы '%pattern%'",//"The input does not match against pattern '%pattern%'",
