...
class NotEmpty extends AbstractValidator
{
    ...
    protected $messageTemplates = array(
        self::IS_EMPTY => "Поле не должно быть пустым.",//"Value is required and can't be empty",
        self::INVALID  => "Неверный тип введеных данных"//"Invalid type given. String, integer, float, boolean or array expected",
    );
